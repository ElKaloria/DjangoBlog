...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Blog API',
    'DESCRIPTION': 'API для управления постами, комментариями, лайками и авторизацией пользователей',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'COMPONENT_SPLIT_REQUEST': True,
    'TAGS': [
        {'name': 'Authentication', 'description': 'Эндпоинты авторизации и аутентификации'},
        {'name': 'Posts', 'description': 'Управление постами'},
        {'name': 'Comments', 'description': 'Управление комментариями'},
        {'name': 'Likes', 'description': 'Управление лайками'},
    ],
}

SOCIAL_AUTH_GITHUB_KEY = django_settings.SOCIAL_AUTH_GITHUB_KEY
SOCIAL_AUTH_GITHUB_SECRET = django_settings.SOCIAL_AUTH_GITHUB_SECRET
